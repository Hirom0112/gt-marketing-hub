...
export const KPI_ROWS: KpiRow[] = [
  ...
  seed('engagement_clicked', 'Engagement-tier mix (clicked)', 'share of contacts in the clicked engagement tier', 0.31, 0.35, [0.27, 0.29, 0.3, 0.31], 'green', { system: 'HubSpot', locator: 'CRMAdapter.read_engagement (EngagementSnapshot.clicked_share)', kind: 'derived', compute: 'clicked / total contacts via the CRM engagement seam', lastSync: null }),
  ...
  seed('objections', 'Objections logged', 'count of logged objections', 47, 0, [33, 39, 42, 47], 'yellow', { system: 'Supabase', locator: 'observability.contact_outcome.objection (count_objections)', kind: 'our_db', compute: 'count of contact-outcome events carrying a logged objection', lastSync: null }),
